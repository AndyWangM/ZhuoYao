...
(function (e) {
  ...
  var f = function () {
    function b(a, c) { this.c = []; this.i = !1; this.b = []; this.N = !1; this.g = []; this.m = []; this.utils = new e.V; this.R = a; this.app = c; -1 != wx.getSystemInfoSync().brand.toLocaleLowerCase().indexOf("iphone") && (this.N = !0) } b.prototype.ca = function () { var a = this; e.SpritesAPI.ha(function (c) { if (c = c.data) { e.SpritesAPI.ia(function (c) { if (c = c.data) a.m = c.data.filters }); c = c.data.sprite_searching_config; for (var d = 0; d < c.length; d++) { var b = a.ea(c[d]); a.g = b } } }) }; b.prototype.ea = function (a) {
      for (var c = [], d = a.xIndex,
        b = a.yIndex, g = 0; g < d; g++)for (var e = a.latitude + 16E3 * g, f = 0; f < b; f++)c.push({ latitude: e, longitude: a.longitude + 19E3 * f }); return c
    }; b.prototype.Z = function (a) { return a.charAt(0).toUpperCase() + a.slice(1) }; b.prototype.Y = function () { var a = this; a.utils.a.getItem("SpriteList") ? console.log(a.utils.a.getItem("SpriteList")) : e.SpritesAPI.da(function (c) { if (200 === c.statusCode) { c = c.data.data.configs; for (var d = [], b = 0; b < c.length; b++) { var e = {}, h; for (h in c[b]) e[a.Z(h)] = c[b][h]; d.push(e) } a.utils.setSpriteConfig(d); a.utils.setSpriteList(d) } }) };
    ...
    b.prototype.G = function () { this.i || (console.log("\u5f00\u59cbWebSocket\u8fde\u63a5"), wx.showLoading({ title: "\u8fde\u63a5\u4e2d" }), wx.connectSocket({ url: "wss://publicld.gwgo.qq.com?account_value=0&account_type=0&appid=0&token=0" })) }; b.prototype.sendMessage = function (a) { this.b.push(a) }; b.prototype.clearMessageQueue = function () { this.b = [] }; b.prototype.clearAllMessageQueue = function () { this.b = []; this.g = [] }; b.prototype.sendSocketMessage = function (a) {
      ...
      (a.packageNO && 1 == a.packageNO || !a.sprite_list || 0 == a.sprite_list.length) && this.b.shift(); a.filter = this.utils.ja(); a.serverFilter =
        this.m; a.type = "front"; if (this.N) {
          if (a.sprite_list) {
            for (var c = a.sprite_list, d = [], b = c.length; b--;) {
              var g = c[b], h; this.utils.getSpriteList().get(g.sprite_id); this.m && this.m[g.sprite_id] && d.push(g); h = a.filter; if (0 < h.length) {
                if (-1 != h.indexOf(g.sprite_id)) {
                  h = this.utils.getSpriteList().get(g.sprite_id); var f = (g.latitude / 1E6).toFixed(6), l = (g.longtitude / 1E6).toFixed(6), n = this.utils.getLocation(l, f), m = g.gentime + g.lifetime, k = h.Name + g.latitude + g.longtitude + m, k = this.utils.hash(k), p = h.HeadImage; this.app.globalData.clickedObj[k] &&
                    (p = "/images/all.png"); g = { hashid: k, name: h.Name, latitude: f, longitude: l, rlatitude: n[1], rlongitude: n[0], lefttime: this.utils.getLeftTime(g.gentime, g.lifetime), totaltime: m, iconPath: p, id: k + ":" + m + ":" + f + " " + l, width: 40, height: 40, callout: { content: h.Name } }; this.utils.getTempResults().put(k, g)
                }
              } else 5 >= 100 * Math.random() && (h = this.utils.getSpriteList().get(g.sprite_id), f = (g.latitude / 1E6).toFixed(6), l = (g.longtitude / 1E6).toFixed(6), n = this.utils.getLocation(l, f), m = g.gentime + g.lifetime, k = h.Name + g.latitude + g.longtitude +
                m, k = this.utils.hash(k), p = h.HeadImage, this.app.globalData.clickedObj[k] && (p = "/images/all.png"), g = { hashid: k, name: h.Name, latitude: f, longitude: l, rlatitude: n[1], rlongitude: n[0], lefttime: this.utils.getLeftTime(g.gentime, g.lifetime), totaltime: m, iconPath: p, id: k + ":" + m + ":" + f + " " + l, width: 40, height: 40, callout: { content: h.Name } }, this.utils.getTempResults().put(k, g))
            } e.SpritesAPI.setSpriteList(d)
          }
        } else this.R.postMessage(a); this.O = (new Date).getTime()
      } else 0 < this.g.length && (this.g.shift(), console.log("\u6536\u5230\u540e\u53f0\u4efb\u52a1\u6d88\u606f",
        new Date), a = JSON.parse(a), a.filter = [], a.type = "back", a.serverFilter = this.m, this.R.postMessage(a))
      ...
      return this.c[0] == a ? "1001" : this.c[1] == a ? "1002" : this.c[2] ==
        a ? "1003" : this.c[3] == a ? "10040" : this.c[4] == a ? "10041" : 0
    }; b.prototype.ga = function () { var a = { request_type: "1004", cfg_type: 1, requestid: this.genRequestId("10041"), platform: 0, appid: "wx19376645db21af08", openid: this.utils.getOpenId(), gwgo_token: this.utils.getToken() }; this.sendMessage(a) }; b.prototype.ka = function (a) { console.log("fileName", a); this.getFileName() != a && (console.log("\u5b58\u5728\u65b0\u7248\uff0c\u5f00\u59cb\u4e0b\u8f7d"), this.I(a)) }; b.prototype.ta = function (a) { this.utils.a.setItem("filename", a) }; b.prototype.getFileName =
      function () { return this.utils.a.getItem("filename") }; b.prototype.I = function (a) { var c = this; wx.downloadFile({ url: "https://hy.gwgo.qq.com/sync/pet/config/" + a, success: function (d) { 200 === d.statusCode ? (console.log("\u4e0b\u8f7d\u6210\u529f" + a), d = wx.getFileSystemManager().readFileSync(d.tempFilePath, "utf8"), d = JSON.parse(d).Data, c.utils.setSpriteConfig(d), c.utils.setSpriteList(d), c.ta(a)) : c.H(a) }, fail: function () { c.H(a) } }) }; b.prototype.H = function (a) { var c = this; console.log(a); setTimeout(function () { c.I(a) }, 3E3) };
    return b
  }(); e.Socket = f
})(ZhuoYao || (ZhuoYao = {})); (function (e) {
  var f = function () {
  ...
  var f = function () {
    function b() { } b.$ = function (a, b) { var c = Math.sqrt(a * a + b * b) + 2E-5 * Math.sin(b * this.S), e = Math.atan2(b, a) + 3E-6 * Math.cos(a * this.S); return [c * Math.cos(e) + .0065, c * Math.sin(e) + .006] }; b.aa = function (a, b) { if (this.na(a, b)) return [a, b]; var c = this.ya(a - 105, b - 35), e = this.za(a - 105, b - 35), g = b / 180 * this.PI, f = Math.sin(g), f = 1 - this.J * f * f, q = Math.sqrt(f), c = 180 * c / (this.F * (1 - this.J) / (f * q) * this.PI), e = 180 * e / (this.F / q * Math.cos(g) * this.PI); return [2 * a - (Number(a) + e), 2 * b - (Number(b) + c)] }; b.ya = function (a, b) {
      var c =
