...
(function (ZhuoYao) {
  var Socket = function () {
    function Socket(app) { this.requestIds = []; this.isOpen = false; this.isConnecting = false; this.messageQueue = []; this.requestResult = new RequestResult; this.app = app } Socket.prototype.initSocket = function () {
