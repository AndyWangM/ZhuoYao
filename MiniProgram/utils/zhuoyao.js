var ZhuoYao;
(function (e) {
  var f = function () { return function () { } }(); e.za = f; var b = function () {
  ...
  var f = function () {
    function b() { this.va = new e.g; this.F = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-".split(""); this.na = "https://hy.gwgo.qq.com/sync/pet/"; this.a = new e.Storage; this.C = new e.W } b.prototype.hash = function (a) { return this.C.hash(a) }; b.prototype.D = function (a) { return this.C.D(a) }; b.prototype.B = function (a) { return this.C.B(a) }; b.prototype.convertLocation = function (a) { return 1E6 * Number(a.toFixed(6)) }; b.prototype.setSpriteConfig = function (a) {
      ...
      this.N();
      return this.l
    }; b.prototype.getSpriteByName = function (a) { var d = this.a.getItem("SpriteList") || [], c = []; if (0 < d.length) for (var b = 0; b < d.length; b++)a ? -1 != d[b].Name.indexOf(a) && c.push(d[b]) : c.push(d[b]); return c }; b.prototype.ha = function () { for (var a = [], d = this.a.getItem("SpriteList"), c = d.length; c--;)d[c].Checked && a.push(d[c].Id); return a }; b.prototype.getTempResults = function () { return this.va }; b.prototype.w = function (a) {
    ...
    }; b.prototype.getLeftTime = function (a, d) { return this.w((a + d - (new Date).getTime() / 1E3).toFixed(0)) }; b.prototype.M = function (a) { return a ? this.na + a.SmallImgPath : "/image/default-head.png" }; b.prototype.getMarkerInfo = function (a) { return a.split(":")[1].split(" ") }; b.prototype.setCoordinate = function (a) { this.v = a; this.a.setItem("coordinate", a) }; b.prototype.getLocation = function (a, d) {
    this.v || (this.v = this.a.getItem("coordinate") ||
      "GCJ02"); switch (this.v) { case "GCJ02": return [a, d]; case "BD09": return e.G.Z(a, d); case "WGS84": return e.G.$(a, d) }
      ...
      this.a.setItem("pagesize",
        a || 20)
    }; b.prototype.getPageSize = function () { return this.ma = this.a.getItem("pagesize") || 20 }; return b
  }(); e.X = f
})(ZhuoYao || (ZhuoYao = {})); (function (e) {
  var f = function () {
    function b(a) { this.b = []; this.i = !1; this.c = []; this.P = !1; this.h = []; this.m = []; this.utils = new e.X; this.T = a; -1 != wx.getSystemInfoSync().brand.toLocaleLowerCase().indexOf("iphone") && (this.P = !0) } b.prototype.ba = function () { var a = this; e.SpritesAPI.fa(function (d) { if (d = d.data) { e.SpritesAPI.ga(function (d) { if (d = d.data) a.m = d.data.filters }); d = d.data.sprite_searching_config; for (var c = 0; c < d.length; c++) { var b = a.ca(d[c]); console.log(d[c].region); a.h = b } } }) }; b.prototype.ca = function (a) {
      for (var d =
      ...
      var a = this; this.ka(); this.ja(); a.I(); wx.onSocketOpen(function () { console.log("WebSocket\u8fde\u63a5\u5df2\u6253\u5f00\uff01"); a.i = !0; for (var d = 0; d < a.c.length; d++)a.sendSocketMessage(a.c[d]); a.ea(); wx.hideLoading() }); wx.onSocketError(function () {
        console.log("WebSocket\u8fde\u63a5\u6253\u5f00\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\uff01");
        a.i = !1
      }); wx.onSocketClose(function () { console.log("WebSocket \u5df2\u5173\u95ed\uff01"); a.i = !1 }); wx.onSocketMessage(function (d) { a.pa(d) })
    }; b.prototype.ka = function () { var a = this; setInterval(function () { a.i || a.I() }, 500) }; b.prototype.ja = function () { var a = this; setInterval(function () { if (0 < a.c.length) { var d = a.c[0]; a.O = !1; a.sendSocketMessage(d) } else 0 < a.h.length ? (d = a.Y(a.h[0]), a.O = !0, a.sendSocketMessage(d)) : a.ba() }, 2E3) }; b.prototype.Y = function (a) {
      return {
    ...
    b.prototype.pa = function (a) {
      a = this.utils.D((new Uint8Array(a.data)).slice(4)); if (0 < a.length) if (0 < this.c.length && !this.O) if (console.log("\u6536\u5230\u670d\u52a1\u5668\u6d88\u606f", new Date), a = JSON.parse(a), 0 != a.retcode && wx.hideLoading(), "10041" == this.da(a.requestid)) this.ia(a.filename), this.c.shift(); else {
      a.packageNO && 1 == a.packageNO && this.c.shift(); a.filter = this.utils.ha(); a.serverFilter = this.m; if (this.P) {
        if (a.sprite_list) {
      ...
      } else this.T.postMessage(a);
        this.R = (new Date).getTime()
      } else 0 < this.h.length && (this.h.shift(), console.log("\u6536\u5230\u540e\u53f0\u4efb\u52a1\u6d88\u606f", new Date), a = JSON.parse(a), a.filter = [], a.serverFilter = this.m, this.T.postMessage(a))
    }; b.prototype.isSearching = function () { return !this.R || 5E3 < (new Date).getTime() - this.R ? !1 : !0 }; b.prototype.genRequestId = function (a) {
  ...
  var f = function () {
    ...
    }; b.prototype.ua = function (a) { for (var b = new ArrayBuffer(2 * a.length), b = new Uint16Array(b), c = 0, e = a.length; c < e; c++)b[c] = a.charCodeAt(c); return b }; b.prototype.B = function (a) { a = this.ua(JSON.stringify(a)); var b = a.length, c = new ArrayBuffer(4); (new DataView(c)).setUint32(0, b); b = new Uint8Array(4 + b); b.set(new Uint8Array(c), 0); b.set(a, 4); return b.buffer }; return b
  }(); e.W = f
})(ZhuoYao || (ZhuoYao = {})); (function (e) { e.Aa = function () { return function () { } }() })(ZhuoYao || (ZhuoYao = {})); (function (e) {
  var f = function () {
...
})(ZhuoYao || (ZhuoYao = {})); (function (e) { var f = function () { function b() { } b.setSpriteList = function (a) { this.o.oa(this.url + this.qa, a) }; b.fa = function (a) { this.o.get(this.sa, null, a) }; b.ga = function (a) { this.o.get(this.ta, null, a) }; b.get = function (a) { this.o.get(this.url + this.aa + a) }; b.url = "https://zhuoyao.wangandi.com/"; b.sa = "https://zhuoyao.wangandi.com/api/config/getSearchConfig"; b.ta = "https://zhuoyao.wangandi.com/api/sprites/filter/get"; b.aa = "api/sprites/get/"; b.qa = "api/sprites/set/"; b.o = new e.V; return b }(); e.SpritesAPI = f })(ZhuoYao ||
  (ZhuoYao = {})); (function (e) {
    var f = function () {
      function b() { } b.Z = function (a, b) { var c = Math.sqrt(a * a + b * b) + 2E-5 * Math.sin(b * this.U), d = Math.atan2(b, a) + 3E-6 * Math.cos(a * this.U); return [c * Math.cos(d) + .0065, c * Math.sin(d) + .006] }; b.$ = function (a, b) { if (this.la(a, b)) return [a, b]; var c = this.wa(a - 105, b - 35), d = this.xa(a - 105, b - 35), e = b / 180 * this.PI, f = Math.sin(e), f = 1 - this.L * f * f, h = Math.sqrt(f), c = 180 * c / (this.H * (1 - this.L) / (f * h) * this.PI), d = 180 * d / (this.H / h * Math.cos(e) * this.PI); return [2 * a - (Number(a) + d), 2 * b - (Number(b) + c)] }; b.wa = function (a, b) {
        var c =
        ...
        var c = 300 + a + 2 * b + .1 * a * a + .1 * a * b + .1 * Math.sqrt(Math.abs(a)), c = c + 2 * (20 * Math.sin(6 * a * this.PI) + 20 * Math.sin(2 * a * this.PI)) / 3, c = c + 2 * (20 * Math.sin(a * this.PI) + 40 * Math.sin(a / 3 * this.PI)) / 3; return c += 2 * (150 * Math.sin(a / 12 * this.PI) + 300 * Math.sin(a / 30 * this.PI)) /
          3
      }; b.la = function (a, b) { return 72.004 > a || 137.8347 < a || .8293 > b || 55.8271 < b || !1 }; b.U = 52.35987755982988; b.PI = 3.141592653589793; b.H = 6378245; b.L = .006693421622965943; return b
    }(); e.G = f
  })(ZhuoYao || (ZhuoYao = {}));
