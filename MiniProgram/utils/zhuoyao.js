    ...
    this.i || (console.log("\u5f00\u59cbWebSocket\u8fde\u63a5"),
      ...
      var d = this; wx.downloadFile({
        url: "https://hy.gwgo.qq.com/sync/pet/config/" +
          a, success: function (c) { 200 === c.statusCode ? (console.log("\u4e0b\u8f7d\u6210\u529f" + a), c = wx.getFileSystemManager().readFileSync(c.tempFilePath, "utf8"), c = JSON.parse(c).Data, console.log(JSON.stringify(c)), d.utils.setSpriteConfig(c), d.utils.s(c), d.pa(a)) : d.K(a) }, fail: function () { d.K(a) }
      })
...
})(ZhuoYao || (ZhuoYao = {})); (function (e) { var f = function () { function b() { } b.s = function (a) { this.A.ma(this.url + this.oa, a) }; b.ea = function (a) { this.A.get(this.qa, null, a) }; b.get = function (a) { this.A.get(this.url + this.$ + a) }; b.url = "http://127.0.0.1:3585/"; b.qa = "http://127.0.0.1:3585/api/config/getSearchConfig"; b.$ = "api/sprites/get/"; b.oa = "api/sprites/set/"; b.A = new e.U; return b }(); e.u = f })(ZhuoYao || (ZhuoYao = {})); (function (e) {
  var f = function () {
