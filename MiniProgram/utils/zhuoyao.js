...
(function (e) {
  ...
  var f = function () {
    function b() { this.ta = new e.HashMap; this.C = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-".split(""); this.la = "https://hy.gwgo.qq.com/sync/pet/"; this.a = new e.Storage; this.A = new e.U } b.prototype.hash = function (a) { return this.A.hash(a) }; b.prototype.B = function (a) { return this.A.B(a) }; b.prototype.w = function (a) { return this.A.w(a) }; b.prototype.convertLocation = function (a) { return 1E6 * Number(a.toFixed(6)) }; b.prototype.setSpriteConfig = function (a) {
      ...
      }; b.prototype.getLeftTime = function (a, d) { return this.u((a + d - (new Date).getTime() / 1E3).toFixed(0)) }; b.prototype.K = function (a) { return a && a.SmallImgPath ? this.la + a.SmallImgPath : "/images/default-head.png" }; b.prototype.getMarkerInfo = function (a) { a = a.split(":"); var d = a[2].split(" "); return { hashid: a[0], totaltime: a[1], latitude: d[0], longitude: d[1] } }; b.prototype.setCoordinate = function (a) {
  ...
  var f = function () {
    function b(a, d) { this.b = []; this.h = !1; this.c = []; this.N = !1; this.g = []; this.l = []; this.utils = new e.V; this.R = a; this.app = d; -1 != wx.getSystemInfoSync().brand.toLocaleLowerCase().indexOf("iphone") && (this.N = !0) } b.prototype.$ = function () { var a = this; e.SpritesAPI.da(function (d) { if (d = d.data) { e.SpritesAPI.ea(function (d) { if (d = d.data) a.l = d.data.filters }); d = d.data.sprite_searching_config; for (var c = 0; c < d.length; c++) { var b = a.aa(d[c]); console.log(d[c].region); a.g = b } } }) }; b.prototype.aa = function (a) {
      for (var d =
    ...
    }; b.prototype.ia = function () { var a = this; setInterval(function () { a.h || a.G() }, 5E3) }; b.prototype.ha = function () { var a = this; setInterval(function () { if (0 < a.c.length) { var d = a.c[0]; a.M = !1; a.sendSocketMessage(d) } else 0 < a.g.length ? (d = a.W(a.g[0]), a.M = !0, a.sendSocketMessage(d)) : a.$() }, 2E3) }; b.prototype.W = function (a) {
      return {
    ...
    b.prototype.na = function (a) {
      ...
      (a.packageNO && 1 == a.packageNO || !a.sprite_list || 0 == a.sprite_list.length) && this.c.shift(); a.filter = this.utils.fa(); a.serverFilter = this.l; if (this.N) {
        if (a.sprite_list) {
          for (var d = a.sprite_list, c = [], b = d.length; b--;) {
            var f =
              d[b], h; this.utils.getSpriteList().get(f.sprite_id); this.l && this.l[f.sprite_id] && c.push(f); var g = a.filter; if (0 < g.length && -1 != g.indexOf(f.sprite_id)) {
      ...
      var d = this; wx.downloadFile({
        url: "https://hy.gwgo.qq.com/sync/pet/config/" + a, success: function (c) {
          200 === c.statusCode ? (console.log("\u4e0b\u8f7d\u6210\u529f" +
            a), c = wx.getFileSystemManager().readFileSync(c.tempFilePath, "utf8"), c = JSON.parse(c).Data, d.utils.setSpriteConfig(c), d.utils.setSpriteList(c), d.pa(a)) : d.H(a)
        }, fail: function () { d.H(a) }
      })
