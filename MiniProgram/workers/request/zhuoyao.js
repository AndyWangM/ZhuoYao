...
(function (e) {
  ...
  var f = function () {
    function b() { this.ta = new e.HashMap; this.C = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-".split(""); this.la = "https://hy.gwgo.qq.com/sync/pet/"; this.a = new e.Storage; this.A = new e.U } b.prototype.hash = function (a) { return this.A.hash(a) }; b.prototype.B = function (a) { return this.A.B(a) }; b.prototype.w = function (a) { return this.A.w(a) }; b.prototype.convertLocation = function (a) { return 1E6 * Number(a.toFixed(6)) }; b.prototype.setSpriteConfig = function (a) {
      this.a.setItem("SpriteList",
        a)
    }; b.prototype.setSpriteList = function (a) { this.i = new e.HashMap; this.j = new e.HashMap; for (var c = a.length; c--;) { var d = a[c]; d.HeadImage = this.K(d); this.i.put(d.Id, d); this.j.put(d.Name, d.Id) } }; b.prototype.L = function () { if (!this.i || !this.j) { this.i = new e.HashMap; this.j = new e.HashMap; for (var a = this.a.getItem("SpriteList"), c = a.length; c--;) { var d = a[c]; d.HeadImage || (d.HeadImage = this.K(d)); this.i.put(d.Id, d); this.j.put(d.Name, d.Id) } } }; b.prototype.getSpriteList = function () { this.L(); return this.i }; b.prototype.getSpriteNameHash =
      function () { this.L(); return this.j }; b.prototype.getSpriteByName = function (a) { var c = this.a.getItem("SpriteList") || [], d = []; if (0 < c.length) for (var b = 0; b < c.length; b++)a ? -1 != c[b].Name.indexOf(a) && d.push(c[b]) : d.push(c[b]); return d }; b.prototype.fa = function () { for (var a = [], c = this.a.getItem("SpriteList"), d = c.length; d--;)c[d].Checked && a.push(c[d].Id); return a }; b.prototype.getTempResults = function () { return this.ta }; b.prototype.u = function (a) {
  ...
  var f = function () {
    function b(a, c) { this.b = []; this.h = !1; this.c = []; this.N = !1; this.g = []; this.l = []; this.utils = new e.V; this.R = a; this.app = c; -1 != wx.getSystemInfoSync().brand.toLocaleLowerCase().indexOf("iphone") && (this.N = !0) } b.prototype.$ = function () { var a = this; e.SpritesAPI.da(function (c) { if (c = c.data) { e.SpritesAPI.ea(function (c) { if (c = c.data) a.l = c.data.filters }); c = c.data.sprite_searching_config; for (var d = 0; d < c.length; d++) { var b = a.aa(c[d]); console.log(c[d].region); a.g = b } } }) }; b.prototype.aa = function (a) {
      for (var c =
        [], d = a.xIndex, b = a.yIndex, e = 0; e < d; e++)for (var f = a.latitude + 16E3 * e, g = 0; g < b; g++)c.push({ latitude: f, longitude: a.longitude + 19E3 * g }); return c
    }; b.prototype.initSocket = function () {
      var a = this; this.ia(); this.ha(); a.G(); wx.onSocketOpen(function () { console.log("WebSocket\u8fde\u63a5\u5df2\u6253\u5f00\uff01"); a.h = !0; for (var c = 0; c < a.c.length; c++)a.sendSocketMessage(a.c[c]); a.ca(); wx.hideLoading() }); wx.onSocketError(function () {
        console.log("WebSocket\u8fde\u63a5\u6253\u5f00\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\uff01");
        a.h = !1
      }); wx.onSocketClose(function () { console.log("WebSocket \u5df2\u5173\u95ed\uff01"); a.h = !1 }); wx.onSocketMessage(function (c) { a.na(c) })
    }; b.prototype.ia = function () { var a = this; setInterval(function () { a.h || a.G() }, 5E3) }; b.prototype.ha = function () { var a = this; setInterval(function () { if (0 < a.c.length) { var c = a.c[0]; a.M = !1; a.sendSocketMessage(c) } else 0 < a.g.length ? (c = a.W(a.g[0]), a.M = !0, a.sendSocketMessage(c)) : a.$() }, 2E3) }; b.prototype.W = function (a) {
      return {
    ...
    b.prototype.na = function (a) {
      ...
      (a.packageNO && 1 == a.packageNO || !a.sprite_list || 0 == a.sprite_list.length) && this.c.shift(); a.filter = this.utils.fa(); a.serverFilter = this.l; if (this.N) {
        if (a.sprite_list) {
          for (var c = a.sprite_list, d = [], b = c.length; b--;) {
            var f =
              c[b], h; this.utils.getSpriteList().get(f.sprite_id); this.l && this.l[f.sprite_id] && d.push(f); var g = a.filter; if (0 < g.length && -1 != g.indexOf(f.sprite_id)) {
                h = this.utils.getSpriteList().get(f.sprite_id); var k = (f.latitude / 1E6).toFixed(6), l = (f.longtitude / 1E6).toFixed(6), n = this.utils.getLocation(l, k), m = f.gentime + f.lifetime, g = this.utils.hash(h.Name + f.latitude + f.longtitude + m), p = h.HeadImage; this.app.globalData.clickedObj[g] && (p = "/images/all.png"); f = {
                  hashid: g, name: h.Name, latitude: k, longitude: l, rlatitude: n[1], rlongitude: n[0],
                  lefttime: this.utils.getLeftTime(f.gentime, f.lifetime), totaltime: m, iconPath: p, id: g + ":" + m + ":" + k + " " + l, width: 40, height: 40, callout: { content: h.Name }
      ...
      return !this.O ||
        5E3 < (new Date).getTime() - this.O ? !1 : !0
    }; b.prototype.genRequestId = function (a) { var c = (new Date).getTime() % 1234567; switch (a) { case "1001": this.b[0] = c; break; case "1002": this.b[1] = c; break; case "1003": this.b[2] = c; break; case "10040": this.b[3] = c; break; case "10041": this.b[4] = c }return c }; b.prototype.ba = function (a) { return this.b[0] == a ? "1001" : this.b[1] == a ? "1002" : this.b[2] == a ? "1003" : this.b[3] == a ? "10040" : this.b[4] == a ? "10041" : 0 }; b.prototype.ca = function () {
      var a = {
        request_type: "1004", cfg_type: 1, requestid: this.genRequestId("10041"),
        platform: 0
      }; this.sendMessage(a)
