var ZhuoYao;
(function (ZhuoYao) {
    var LocationTrans = /** @class */ (function () {
        function LocationTrans() {
        }
        /**
         ...
         * @returns {*[]}
         */
        LocationTrans.gcj02tobd09 = function (lng, lat) {
         ...
         * @returns {*[]}
         */
        LocationTrans.gcj02towgs84 = function (lng, lat) {
         ...
         * @returns {boolean}
         */
        LocationTrans.out_of_china = function (lng, lat) {
            return (lng < 72.004 || lng > 137.8347) || ((lat < 0.8293 || lat > 55.8271) || false);
        };
        LocationTrans.x_PI = 3.14159265358979324 * 3000.0 / 180.0;
