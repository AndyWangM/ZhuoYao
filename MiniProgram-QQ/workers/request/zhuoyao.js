...
})(ZhuoYao || (ZhuoYao = {})); (function (e) { var f = function () { function b() { } b.prototype.setItem = function (a, d) { qq.setStorage({ key: a, data: d }) }; b.prototype.getItem = function (a) { return qq.getStorageSync(a) }; return b }(); e.Storage = f })(ZhuoYao || (ZhuoYao = {})); (function (e) { var f = function () { function b() { } b.prototype.get = function (a, d, c, b) { qq.request({ url: a, data: d, method: "GET", success: function (a) { c(a, b) }, failed: function (a) { console.log(a) } }) }; b.prototype.ma = function (a, d) { qq.request({ url: a, method: "POST", data: d, header: { "content-type": "application/json" }, success: function () { }, failed: function (a) { console.log(a) } }) }; return b }(); e.T = f })(ZhuoYao || (ZhuoYao = {})); (function (e) {
  var f = function () {
    function b() { this.ta = new e.HashMap; this.C = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-".split(""); this.la = "https://hy.gwgo.qq.com/sync/pet/"; this.a = new e.Storage; this.A = new e.U } b.prototype.hash = function (a) { return this.A.hash(a) }; b.prototype.B = function (a) { return this.A.B(a) }; b.prototype.w = function (a) { return this.A.w(a) }; b.prototype.convertLocation = function (a) { return 1E6 * Number(a.toFixed(6)) }; b.prototype.setSpriteConfig = function (a) {
      ...
      }; b.prototype.getLeftTime = function (a, d) { return this.u((a + d - (new Date).getTime() / 1E3).toFixed(0)) }; b.prototype.K = function (a) { return a ? this.la + a.SmallImgPath : "/image/default-head.png" }; b.prototype.getMarkerInfo = function (a) { a = a.split(":"); var d = a[2].split(" "); return { hashid: a[0], totaltime: a[1], latitude: d[0], longitude: d[1] } }; b.prototype.setCoordinate = function (a) {
      this.s = a; this.a.setItem("coordinate",
        a)
      }; b.prototype.getLocation = function (a, d) { this.s || (this.s = this.a.getItem("coordinate") || "GCJ02"); switch (this.s) { case "GCJ02": return [a, d]; case "BD09": return e.D.X(a, d); case "WGS84": return e.D.Y(a, d) } }; b.prototype.setSplitSign = function (a) { this.v = a; this.a.setItem("splitsign", a) }; b.prototype.getSplitSign = function () { "spacesplit" == (this.a.getItem("splitsign") || "spacesplit") ? this.v = " " : this.v = ","; return this.v }; b.prototype.setLonfront = function (a) { this.P = a; this.a.setItem("lonfront", a) }; b.prototype.getLonfront =
        function () { return this.P = this.a.getItem("lonfront") }; b.prototype.setPageSize = function (a) { this.a.setItem("pagesize", a || 20) }; b.prototype.getPageSize = function () { return this.ka = this.a.getItem("pagesize") || 20 }; return b
  }(); e.V = f
})(ZhuoYao || (ZhuoYao = {})); (function (e) {
  var f = function () {
    function b(a, d) { this.b = []; this.h = !1; this.c = []; this.N = !1; this.g = []; this.l = []; this.utils = new e.V; this.R = a; this.app = d; -1 != qq.getSystemInfoSync().brand.toLocaleLowerCase().indexOf("iphone") && (this.N = !0) } b.prototype.$ = function () { var a = this; e.SpritesAPI.da(function (d) { if (d = d.data) { e.SpritesAPI.ea(function (d) { if (d = d.data) a.l = d.data.filters }); d = d.data.sprite_searching_config; for (var c = 0; c < d.length; c++) { var b = a.aa(d[c]); console.log(d[c].region); a.g = b } } }) }; b.prototype.aa = function (a) {
      for (var d =
        [], c = a.xIndex, b = a.yIndex, e = 0; e < c; e++)for (var f = a.latitude + 16E3 * e, g = 0; g < b; g++)d.push({ latitude: f, longitude: a.longitude + 19E3 * g }); return d
    }; b.prototype.initSocket = function () {
      var a = this; this.ia(); this.ha(); a.G(); qq.onSocketOpen(function () { console.log("WebSocket\u8fde\u63a5\u5df2\u6253\u5f00\uff01"); a.h = !0; for (var d = 0; d < a.c.length; d++)a.sendSocketMessage(a.c[d]); a.ca(); qq.hideLoading() }); qq.onSocketError(function () {
        console.log("WebSocket\u8fde\u63a5\u6253\u5f00\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\uff01");
        a.h = !1
      }); qq.onSocketClose(function () { console.log("WebSocket \u5df2\u5173\u95ed\uff01"); a.h = !1 }); qq.onSocketMessage(function (d) { a.na(d) })
    ...
    }; b.prototype.G = function () { this.h || (console.log("\u5f00\u59cbWebSocket\u8fde\u63a5"), qq.showLoading({ title: "\u8fde\u63a5\u4e2d" }), qq.connectSocket({ url: "wss://publicld.gwgo.qq.com?account_value=0&account_type=0&appid=0&token=0" })) }; b.prototype.sendMessage = function (a) { this.c.push(a) }; b.prototype.clearMessageQueue = function () { this.c = [] }; b.prototype.sendSocketMessage = function (a) { qq.sendSocketMessage({ data: this.utils.w(a), success: function () { }, fail: function () { console.log("\u53d1\u9001\u670d\u52a1\u5668\u5931\u8d25") } }) };
    b.prototype.na = function (a) {
      a = this.utils.B((new Uint8Array(a.data)).slice(4)); if (0 < a.length) if (0 < this.c.length && !this.M) if (console.log("\u6536\u5230\u670d\u52a1\u5668\u6d88\u606f", new Date), a = JSON.parse(a), 0 != a.retcode && qq.hideLoading(), "10041" == this.ba(a.requestid)) this.ga(a.filename), this.c.shift(); else {
      a.packageNO && 1 == a.packageNO && this.c.shift(); a.filter = this.utils.fa(); a.serverFilter = this.l; if (this.N) {
        if (a.sprite_list) {
          for (var d = a.sprite_list, c = [], b = d.length; b--;) {
            var f = d[b], h; this.utils.getSpriteList().get(f.sprite_id);
            this.l && this.l[f.sprite_id] && c.push(f); var g = a.filter; if (0 < g.length && -1 != g.indexOf(f.sprite_id)) {
              h = this.utils.getSpriteList().get(f.sprite_id); var k = (f.latitude / 1E6).toFixed(6), l = (f.longtitude / 1E6).toFixed(6), n = this.utils.getLocation(l, k), m = f.gentime + f.lifetime, g = this.utils.hash(h.Name + f.latitude + f.longtitude + m), p = h.HeadImage; this.app.globalData.clickedObj[g] && (p = "/images/all.png"); f = {
                hashid: g, name: h.Name, latitude: k, longitude: l, rlatitude: n[1], rlongitude: n[0], lefttime: this.utils.getLeftTime(f.gentime,
                  f.lifetime), totaltime: m, iconPath: p, id: g + ":" + m + ":" + k + " " + l, width: 40, height: 40, callout: { content: h.Name }
              }; this.utils.getTempResults().put(g, f)
            }
    ...
    }; b.prototype.isSearching = function () { return !this.O || 5E3 < (new Date).getTime() - this.O ? !1 : !0 };
    b.prototype.genRequestId = function (a) { var d = (new Date).getTime() % 1234567; switch (a) { case "1001": this.b[0] = d; break; case "1002": this.b[1] = d; break; case "1003": this.b[2] = d; break; case "10040": this.b[3] = d; break; case "10041": this.b[4] = d }return d }; b.prototype.ba = function (a) { return this.b[0] == a ? "1001" : this.b[1] == a ? "1002" : this.b[2] == a ? "1003" : this.b[3] == a ? "10040" : this.b[4] == a ? "10041" : 0 }; b.prototype.ca = function () { var a = { request_type: "1004", cfg_type: 1, requestid: this.genRequestId("10041"), platform: 0 }; this.sendMessage(a) };
    b.prototype.ga = function (a) { console.log("fileName", a); this.getFileName() != a && (console.log("\u5b58\u5728\u65b0\u7248\uff0c\u5f00\u59cb\u4e0b\u8f7d"), this.I(a)) }; b.prototype.pa = function (a) { this.utils.a.setItem("filename", a) }; b.prototype.getFileName = function () { return this.utils.a.getItem("filename") }; b.prototype.I = function (a) {
      var d = this; qq.downloadFile({
        url: "https://hy.gwgo.qq.com/sync/pet/config/" + a, success: function (c) {
          200 === c.statusCode ? (console.log("\u4e0b\u8f7d\u6210\u529f" + a), c = qq.getFileSystemManager().readFileSync(c.tempFilePath,
            "utf8"), c = JSON.parse(c).Data, d.utils.setSpriteConfig(c), d.utils.setSpriteList(c), d.pa(a)) : d.H(a)
        }, fail: function () { d.H(a) }
      })
...
})(ZhuoYao || (ZhuoYao = {})); (function (e) { var f = function () { function b() { } b.setSpriteList = function (a) { this.m.ma(this.url + this.oa, a) }; b.da = function (a) { this.m.get(this.qa, null, a) }; b.ea = function (a) { this.m.get(this.ra, null, a) }; b.get = function (a) { this.m.get(this.url + this.Z + a) }; b.url = "https://www.wangandi.com/"; b.qa = "https://www.wangandi.com/api/config/getSearchConfig"; b.ra = "https://www.wangandi.com/api/sprites/filter/get"; b.Z = "api/sprites/get/"; b.oa = "api/sprites/set/"; b.m = new e.T; return b }(); e.SpritesAPI = f })(ZhuoYao || (ZhuoYao =
  {})); (function (e) {
    var f = function () {
      function b() { } b.X = function (a, b) { var d = Math.sqrt(a * a + b * b) + 2E-5 * Math.sin(b * this.S), e = Math.atan2(b, a) + 3E-6 * Math.cos(a * this.S); return [d * Math.cos(e) + .0065, d * Math.sin(e) + .006] }; b.Y = function (a, b) { if (this.ja(a, b)) return [a, b]; var d = this.ua(a - 105, b - 35), e = this.va(a - 105, b - 35), f = b / 180 * this.PI, h = Math.sin(f), h = 1 - this.J * h * h, g = Math.sqrt(h), d = 180 * d / (this.F * (1 - this.J) / (h * g) * this.PI), e = 180 * e / (this.F / g * Math.cos(f) * this.PI); return [2 * a - (Number(a) + e), 2 * b - (Number(b) + d)] }; b.ua = function (a, b) {
        var c =
